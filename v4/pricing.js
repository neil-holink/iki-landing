...
(function pricing(){
  ...
  /* Dense, text-rich matrix (dub + ahrefs style): a real number/qualifier in every included cell, sub-limit rows for depth. */
  const GROUPS=[
    ["Links & QR",[
      ["Short links","Unlimited","Unlimited","Unlimited","Unlimited","Branded short links with no monthly cap."],
      ["Custom domains",false,"1","3","Unlimited","Connect your own branded domain so links look like you."],
      ["Tags & folders","25","Unlimited","Unlimited","Unlimited","Organize links with tags and nested folders."],
      ["Branded QR codes","Standard","+ Logo","+ Logo","+ Logo","Styled, high-res QR codes — paid plans add your logo."],
      ["UTM builder + templates","Basic","Advanced","Advanced","Advanced","Build and save reusable UTM campaign templates."],
      ["Custom link previews","Standard","Custom","Custom","Custom","Control the title, image and text social platforms show."],
      ["Deep links (mobile)",false,false,"Included","Included","Open links straight inside native mobile apps."],
      ["Link expiration & scheduling",false,"Included","Included","Included","Auto-expire links or schedule them to go live later."],
      ["Password-protected links",false,false,"Included","Included","Lock sensitive links behind a password."],
      ["Bulk creation",false,"CSV","CSV + API","CSV + API","Create links in bulk via CSV import or the API."]]],
    ["Analytics",[
      ["Tracked clicks & events","10K /mo","100K /mo","1M /mo","Unlimited","Click and conversion events tracked each month."],
      ["Conversion goals","3 goals","10 goals","50 goals","Unlimited","Track sign-ups, sales and custom conversions."],
      ["Geo, device & referrer","Included","Included","Included","Included","Break clicks down by country, device and source."],
      ["UTM & campaign reports",false,"Included","Included","Included","Group performance by campaign, source and medium."],
      ["AI Insights & forecasting",false,false,"Included","Included","AI explains your data and forecasts where it is heading."],
      ["Advanced traffic insights",false,false,false,"Included","Cohorts, funnels and multi-touch attribution."],
      ["Data retention","10 days","30 days","60 days","90 days","How long click and conversion history stays queryable."],
      ["Scheduled exports",false,"CSV","CSV + API","Scheduled","Export raw data on demand or on a schedule."]]],
    ["Smart routing",[
      ["Geo & device targeting",false,false,"Included","Included","Send each visitor to the right place by geo and device."],
      ["AI Router (auto-optimize)",false,false,"Included","Included","AI learns from conversions and routes to the best variant."],
      ["Rule-based routing",false,"5 rules","50 rules","Unlimited","If/then rules on country, device, language and source."],
      ["A/B testing",false,false,"3 variants","Unlimited","Split-test destinations and let the winner take traffic."],
      ["Retargeting pixels",false,false,"3","Unlimited","Drop ad pixels on every click to re-engage visitors."],
      ["Deep-link routing",false,false,false,"Included","Route mobile visitors into the right in-app screen."]]],
    ["Team",[
      ["Workspace seats","1","3","10","Unlimited","Teammates who can create and manage links."],
      ["Shared folders",false,"3","20","Unlimited","Organize links into shared team folders."],
      ["Roles & permissions",false,false,"Standard","Advanced","Granular, role-based access for every teammate."],
      ["Activity log",false,"30 days","90 days","1 year","See who created, edited or deleted each link."],
      ["SSO / SAML / SCIM",false,false,false,"Included","Enterprise single sign-on and user provisioning."]]],
    ["Developer",[
      ["REST API access",false,false,"Included","Included","Create, update and read links programmatically."],
      ["API rate limit",false,false,"100K calls /mo","Unlimited","Monthly request budget for the API."],
      ["Webhooks",false,false,"10","Unlimited","Real-time event webhooks you can register."],
      ["Native integrations",false,"50+","50+","Unlimited","Zapier, Make, Slack and direct integrations."],
      ["White-label dashboards",false,false,false,"Included","Branded, embeddable analytics dashboards for clients."]]],
    ["Support & security",[
      ["Support","Community","Email","Priority","Dedicated CSM","How you reach our team for help."],
      ["Response time","Best effort","48 hours","8 hours","1 hour SLA","Typical first-response time."],
      ["Uptime SLA",false,false,false,"99.99%","A contractual uptime guarantee."],
      ["Audit logs",false,false,false,"1 year","A compliance-grade audit trail of workspace activity."],
      ["SOC 2 + GDPR / DPA",false,false,false,"Included","Security certifications and data agreements."],
      ["Custom contract & invoicing",false,false,false,"Included","MSA, custom terms and PO / invoice billing."]]],
  ];
  ...
  /* dub-style: every included cell = small check + value/qualifier text; absent = muted dash */
  const VCHK='<svg class="prvc" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3.4" stroke-linecap="round" stroke-linejoin="round"><path d="m5 12 5 5L20 7"/></svg>';
  const cell=v=> v===false ? dash : `<span class="prval">${VCHK}${v===true?'Included':v}</span>`;
